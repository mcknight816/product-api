...
class CategoryControllerTest {
  ...
  void before() {
      ...
      mono = generator.nextObject(Category.class);
      flux = Arrays.asList(generator.nextObject(Category.class), generator.nextObject(Category.class));
  ...
  void shouldFindById() throws Exception {
    ...
    Category ret =  objectMapper.readValue(response.getContentAsString(),Category.class);
